...
[install-apps title="EcoRide App is Available" description="Install App" apps_description="Manage all your car rentals on the go with the EcoRide app" android_app_url="/contact" android_app_image="install-apps/googleplay.png" ios_app_url="/contact" ios_app_image="install-apps/appstore.png" decor_image="install-apps/truck.png"][/install-apps]</code></pre>
            <br>
