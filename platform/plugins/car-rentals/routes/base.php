...
use Botble\CarRentals\Http\Controllers\StoreRevenueController;
use Botble\CarRentals\Http\Controllers\WithdrawalController;
    ...
    Route::group(['namespace' => 'Botble\CarRentals\Http\Controllers'], function (): void {
        Route::group(['prefix' => 'car-rentals', 'as' => 'car-rentals.'], function (): void {
            ...
            Route::group([
                'prefix' => 'reports',
                'as' => 'reports.',
                'permission' => 'car-rentals.reports',
