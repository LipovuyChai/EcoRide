...
class CarForm extends FormAbstract
{
    public function setup(): void
    {
        ...
        $this
            ...
            // Rental Information (shown when car_purpose is 'rent')
            ...
            ->add(
                ...
                TextFieldOption::make()
                    ...
                    ->placeholder(trans('plugins/car-rentals::car-rentals.car.placeholders.current_location'))
            )
            ->add(
                'pick_address_id',
                SelectField::class,
